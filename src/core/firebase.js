...
import { getFirestore, collection, addDoc, query, where, getDocs, deleteDoc, doc, setDoc, getDoc, Timestamp, orderBy } from "https://www.gstatic.com/firebasejs/10.7.1/firebase-firestore.js";
...
export { db, collection, addDoc, query, where, getDocs, deleteDoc, doc, setDoc, getDoc, Timestamp, orderBy };